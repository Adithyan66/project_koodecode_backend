...
import { IGetAdminActiveContestsUseCase } from '../../../interfaces/IAdminContestUseCase';
...
@injectable()
export class GetAdminActiveContestsUseCase implements IGetAdminActiveContestsUseCase {
  constructor(
  ...
  async execute(): Promise<AdminContestListResponseDto> {
    ...
    const contests = await this.contestRepository.findActive();
